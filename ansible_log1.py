...
class AnsibleLogChunker:
    ...
    def __init__(self):
        # Patterns for Ansible log structure
        ...
        for i, line in enumerate(lines):
            ...
            if play_match:
                ...
                if current_task and current_block:
                    chunks.append(self._create_task_chunk(
            ...
            # Detect PLAY RECAP (end of execution)
    ...
    def _create_task_chunk(
        ...
        for line in lines:
            ...
            if host_match:
                ...
                # Overall task status (worst case)
